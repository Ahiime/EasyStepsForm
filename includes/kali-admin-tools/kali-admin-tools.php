 ...
 * @since   1.0.0
 * @author  BLYD3D
 * @package Easy_Steps_Form_Admin_Tools
 */
class Easy_Steps_Form_Admin_Tools {
		...
		foreach ( $options as $value ) {
			...
			switch ( $value['type'] ) {
				...
				case 'repeatable-fields':
					...
					$tpl_id                         = uniqid();
					$easy_steps_form_tpl[ $tpl_id ] = $row_tpl;

					$add_label = self::get_parse_value( $value, 'add_btn_label', __( 'Add', 'blyd3d' ) );
					?>
							</tbody>
						</table>
						<a class="button mg-top easy-steper-add-new-row" data-tpl2="[{<?php echo esc_attr( $tpl_id ); ?>}]"
	...
	public static function get_allowed_tags() {
		...
		$allowed_tags['input'] = array(
			...
			'data-label'             => array(),
			'data-rule-required'     => array(),
			'data-msg-required'      => array(),
		);
